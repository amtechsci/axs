...
protectedRouter.get('/get-user', apiController.get_user);
protectedRouter.get('/notification', apiController.notification);
protectedRouter.get('/get-subscription-plan', apiController.get_subscription);
protectedRouter.get('/user-current-subscription', apiController.user_current_subscription);
